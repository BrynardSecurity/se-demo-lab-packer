...
variable "os-iso-path" {
  type    = string
  default = "[nfsdatastore01] os/microsoft/desktop/windows 10/2004/windows10_noprompt.iso"
}
...
source "vsphere-iso" "autogenerated_1" {
  ...
  firmware             = "efi"
  floppy_files         = ["autounattend.xml", "../drivers/pvscsi-win8/pvscsi.cat", "../drivers/pvscsi-win8/pvscsi.inf", "../drivers/pvscsi-win8/pvscsi.sys", "../drivers/pvscsi-win8/txtsetup.oem", "../scripts/00-vmtools64.cmd", "../scripts/01-initialize.ps1", "../scripts/03-systemsettings.ps1", "../scripts/95-enablerdp.ps1"]
...
build {
  ...
  provisioner "powershell" {
    scripts = ["../scripts/03-systemsettings.ps1", "../scripts/95-enablerdp.ps1"]
  }
