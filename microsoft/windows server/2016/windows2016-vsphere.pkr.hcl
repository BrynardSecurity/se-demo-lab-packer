...
variable "os-iso-path" {
  type    = string
  default = "[nfsdatastore01] os/microsoft/server/2016/windows2016_noprompt.iso"
}
...
source "vsphere-iso" "autogenerated_1" {
  ...
  firmware             = "efi"
  floppy_files         = ["server_standard/autounattend.xml", "../drivers/pvscsi-win8/pvscsi.cat", "../drivers/pvscsi-win8/pvscsi.inf", "../drivers/pvscsi-win8/pvscsi.sys", "../drivers/pvscsi-win8/txtsetup.oem", "../scripts/2016/00-vmtools64.cmd", "../scripts/2016/01-initialize.ps1", "../scripts/2016/03-systemsettings.ps1", "../scripts/2016/95-enablerdp.ps1"]
...
build {
  ...
  provisioner "powershell" {
    scripts = ["../scripts/2016/03-systemsettings.ps1", "../scripts/2016/95-enablerdp.ps1"]
  }
